    ...
    <div class="card" style="margin-bottom:16px">
      ...
      <div class="card-body">
        ...
        <div id="ctab-tax" style="display:${clientDetailActiveTab === 'tax' ? '' : 'none'};">
          ...
          ${!isNew ? `<div class="detail-row"><div class="detail-label">AI利用の同意</div><div class="detail-value">${editing ? renderClientAiConsentReadonly(c) : renderClientAiConsentValue(c)}</div></div>` : ''}
