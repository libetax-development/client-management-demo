...
const MOCK_DATA = {
  ...
  clients: [
    ...
    { id: 'c-004', clientCode: '030453', name: '株式会社リベ不動産', clientType: '法人', fiscalMonth: 6, isActive: true, mainUserId: 'u-003', subUserId: null, mgrUserId: 'u-003', monthlySales: 80000, address: '大阪府大阪市北区梅田1-4-4', tel: '06-1234-5004', representative: '高橋 花子', establishDate: '2018-01-15', industry: '不動産業', taxOffice: '北税務署', memo: '', cwAccountId: '1234004', cwAccountName: '高橋花子（リベ不動産）', customFieldValues: { 'cf-001': 'MK-11111', 'cf-002': '2023-06-01', 'cf-003': '不動産管理メイン。決算前にヒアリング必要。' } },
