...
const MOCK_DATA = {
  ...
  // Phase 1: 報告書データ
  // status: 'draft' = 下書き / 'published' = 公開済み（FB#53 一時保存対応）
  reports: [
    { id: 'rp-d01', createdAt: '2026-05-04T11:30:00', authorId: 'u-001', type: '業務報告書', category: '確定申告', clientName: '中村衣里', title: '【確定申告】会計帳簿チェック／中村衣里／資料確認中', rank: 'B', readStatus: '一時保存中', hasAttachment: false, status: 'draft', body: '【確定申告】中村衣里\n\n■ 作業内容\n会計帳簿チェック（資料確認中）\n\n■ 実施事項\n・freeeから会計データ取り込み\n・前年度仕訳との比較\n\n■ 確認事項\n（記入中）' },
    { id: 'rp-d02', createdAt: '2026-05-03T18:15:00', authorId: 'u-001', type: '業務報告書', category: '月次業務', clientName: '株式会社デジタルソリューション', title: '月次報告／株式会社デジタルソリューション／4月度（書きかけ）', rank: 'A', readStatus: '一時保存中', hasAttachment: false, status: 'draft', body: '【月次業務】株式会社デジタルソリューション\n\n■ 作業内容\n月次試算表の作成\n\n■ 実施事項\n・売上計上漏れチェック\n・経費按分の見直し\n（続きはあとで）' },
    { id: 'rp-d03', createdAt: '2026-05-02T09:45:00', authorId: 'u-001', type: '日報', category: '日報', clientName: '', title: '5/2 業務日報（下書き）', rank: '日報', readStatus: '一時保存中', hasAttachment: false, status: 'draft', body: '【日報】5/2\n\n■ 本日の業務\n・顧客対応\n・申告書チェック\n\n■ 明日の予定\n（あとで埋める）' },
    { id: 'rp-001', createdAt: '2026-03-10T10:30:00', authorId: 'u-008', type: '業務報告書', category: '月次業務', clientName: '合同会社WANT', title: '月次報告／合同会社WANT／月次業務／1月度', rank: 'B', readStatus: '一時保存中', hasAttachment: false, status: 'draft' },
    { id: 'rp-002', createdAt: '2026-03-09T16:00:00', authorId: 'u-004', type: '業務報告書', category: '確定申告', clientName: '角井 仁', title: '角井 仁／【確定申告】会計チェック', rank: 'B', readStatus: '未読', hasAttachment: false, status: 'published' },
    { id: 'rp-003', createdAt: '2026-03-09T15:30:00', authorId: 'u-004', type: '業務報告書', category: '確定申告', clientName: '桑原 健介', title: '桑原 健介／【確定申告】会計チェック', rank: 'B', readStatus: '一時保存中', hasAttachment: false, status: 'draft' },
    { id: 'rp-004', createdAt: '2026-03-09T15:00:00', authorId: 'u-004', type: '業務報告書', category: '確定申告', clientName: '高見 祐介', title: '高見 祐介／【確定申告】会計チェック', rank: 'B', readStatus: '未読', hasAttachment: false, status: 'published' },
    { id: 'rp-005', createdAt: '2026-03-09T14:00:00', authorId: 'u-003', type: '業務報告書', category: 'その他', clientName: '株式会社CRAT', title: '株式会社CRAT／zoom面談', rank: 'A', readStatus: '未読', hasAttachment: false, status: 'published' },
    { id: 'rp-006', createdAt: '2026-03-09T11:00:00', authorId: 'u-005', type: '業務報告書', category: '決算業務', clientName: '小松　和幸', title: '【確定申告】会計帳簿チェック／小松　和幸／決算業務／納先生 確定申告書（スポット）チェック', rank: 'A', readStatus: '未読', hasAttachment: false, status: 'published' },
    { id: 'rp-007', createdAt: '2026-03-09T10:30:00', authorId: 'u-005', type: '業務報告書', category: '決算業務', clientName: '谷口　哲也', title: '【確定申告】会計帳簿チェック／谷口　哲也／決算業務／納先生 会計帳簿チェック', rank: 'A', readStatus: '未読', hasAttachment: false, status: 'published' },
    { id: 'rp-008', createdAt: '2026-03-08T17:00:00', authorId: 'u-003', type: '業務報告書', category: '決算業務', clientName: '豊田奈美　mcストア', title: '【確定申告】会計帳簿チェック／豊田奈美　mcストア／決算業務／むらっち先生に帳簿チェック依頼', rank: 'B', readStatus: '未読', hasAttachment: false, status: 'published' },
    { id: 'rp-009', createdAt: '2026-03-08T16:30:00', authorId: 'u-007', type: '業務報告書', category: '決算業務', clientName: '岩井裕之', title: '【確定申告】会計帳簿チェック／岩井裕之／決算業務', rank: 'B', readStatus: '未読', hasAttachment: false, status: 'published' },
    { id: 'rp-010', createdAt: '2026-03-08T16:00:00', authorId: 'u-007', type: '業務報告書', category: '決算業務', clientName: '加藤洋一', title: '【確定申告】会計帳簿チェック／加藤洋一／決算業務', rank: 'B', readStatus: '未読', hasAttachment: false, status: 'published' },
    { id: 'rp-011', createdAt: '2026-03-08T15:30:00', authorId: 'u-007', type: '業務報告書', category: '決算業務', clientName: '来馬健太', title: '【確定申告】会計帳簿チェック／来馬健太', rank: 'C', readStatus: '未読', hasAttachment: false, status: 'published' },
    { id: 'rp-012', createdAt: '2026-03-08T15:00:00', authorId: 'u-006', type: '業務報告書', category: 'その他', clientName: '足助川合自動車株式会社', title: '足助川合自動車株式会社／その他／ 【照井】川合さま　ミーティング', rank: 'A', readStatus: '未読', hasAttachment: false, status: 'published' },
    { id: 'rp-013', createdAt: '2026-03-08T14:00:00', authorId: 'u-009', type: '業務報告書', category: '確定申告', clientName: '黄　昭然', title: '【確定申告】会計帳簿チェック／黄　昭然', rank: 'B', readStatus: '未読', hasAttachment: true, status: 'published' },
    { id: 'rp-014', createdAt: '2026-03-08T13:30:00', authorId: 'u-009', type: '業務報告書', category: '確定申告', clientName: '山縣雄輔', title: '【確定申告】会計帳簿チェック／山縣雄輔／令和7年分確定申告', rank: 'B', readStatus: '未読', hasAttachment: false, status: 'published' },
    { id: 'rp-015', createdAt: '2026-03-08T12:00:00', authorId: 'u-008', type: '業務報告書', category: '決算業務', clientName: 'kurashi-goto合同会社', title: '【新】消費税検討／kurashi-goto合同会社／決算業務／令和９年３月期　消費税検討', rank: 'A', readStatus: '未読', hasAttachment: true, status: 'published' },
    { id: 'rp-016', createdAt: '2026-03-07T17:00:00', authorId: 'u-003', type: '業務報告書', category: '決算業務', clientName: '石橋廣樹', title: '【確定申告】会計帳簿チェック／石橋廣樹／決算業務／決算帳簿チェック、仕訳修正等、納先生にチェック依頼', rank: 'B', readStatus: '未読', hasAttachment: false, status: 'published' },
    { id: 'rp-017', createdAt: '2026-03-07T16:30:00', authorId: 'u-003', type: '業務報告書', category: '決算業務', clientName: '安永雅史', title: '【確定申告】会計帳簿チェック／安永雅史／決算業務／納先生に帳簿チェック依頼', rank: 'B', readStatus: '未読', hasAttachment: false, status: 'published' },
    { id: 'rp-018', createdAt: '2026-03-07T16:00:00', authorId: 'u-007', type: '業務報告書', category: '決算業務', clientName: '北澤聖士', title: '【確定申告】会計帳簿チェック／北澤聖士／決算業務', rank: 'C', readStatus: '一時保存中', hasAttachment: false, status: 'draft' },
    { id: 'rp-019', createdAt: '2026-03-07T15:30:00', authorId: 'u-007', type: '業務報告書', category: '決算業務', clientName: '山本敬之', title: '【確定申告】会計帳簿チェック／山本敬之／決算業務', rank: 'B', readStatus: '未読', hasAttachment: false, status: 'published' },
    { id: 'rp-020', createdAt: '2026-03-07T15:00:00', authorId: 'u-006', type: '業務報告書', category: 'その他', clientName: '庭山 勇気', title: '庭山 勇気／その他／【水谷・照井】庭山さま　ミーティング', rank: 'A', readStatus: '未読', hasAttachment: false, status: 'published' },
    { id: 'rp-021', createdAt: '2026-03-07T10:00:00', authorId: 'u-002', type: '日報', category: '日報', clientName: '', title: '3/7 業務日報', rank: '日報', readStatus: '既読', hasAttachment: false, status: 'published' },
    { id: 'rp-022', createdAt: '2026-03-06T18:00:00', authorId: 'u-004', type: '業務報告書', category: '月次業務', clientName: '株式会社デジタルソリューション', title: '月次報告／株式会社デジタルソリューション／月次業務／2月度', rank: 'A', readStatus: '既読', hasAttachment: true, status: 'published' },
    { id: 'rp-023', createdAt: '2026-03-06T17:00:00', authorId: 'u-005', type: '業務報告書', category: '決算業務', clientName: '田中 一郎', title: '【確定申告】会計帳簿チェック／田中 一郎／決算業務', rank: 'B', readStatus: '既読', hasAttachment: false, status: 'published' },
    { id: 'rp-024', createdAt: '2026-03-06T10:00:00', authorId: 'u-009', type: '日報', category: '日報', clientName: '', title: '3/6 業務日報', rank: '日報', readStatus: '既読', hasAttachment: false, status: 'published' },
    { id: 'rp-025', createdAt: '2026-03-05T16:00:00', authorId: 'u-003', type: '業務報告書', category: '決算業務', clientName: '株式会社サンプル商事', title: '株式会社サンプル商事／決算業務／法人税申告書 仕訳確認着手', rank: 'A', readStatus: '既読', hasAttachment: false, status: 'published' },
  ],
  ...
  // カスタムフィールド定義
  customFields: [
    { id: 'cf-001', name: 'マーケコード', type: 'text', order: 1 },
    { id: 'cf-002', name: '契約開始日確認', type: 'date', order: 2 },
